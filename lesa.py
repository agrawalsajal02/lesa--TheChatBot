...
if __name__ == '__main__':
    ...
    while True:
        ...
        if 'hello' in voice_note:
            ...
            speak_text_cmd('My name is sexy ! i want to sex with you. i belongs to the dark part of forest . i am hungry for sex . can you feed my hunger. please help me..choot marlo mere')
